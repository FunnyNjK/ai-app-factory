...
const requiredFiles = [
  ...
  "docs/adr/0012-interactive-factory-tui.md",
  "docs/adr/0013-configurable-roles-and-tools.md",
  "docs/choosing-a-blueprint.md",
  "docs/playbooks/escalation-trail-example.md",
  "docs/playbooks/first-project-walkthrough.md",
  "docs/playbooks/running-a-project.md",
  ...
  "scripts/orchestrator/codereview-phase-review.sh",
  ...
  "scripts/orchestrator/security-phase-review.sh",
  ...
  "templates/factory-roles.default.json",
  "templates/ADR.md",
